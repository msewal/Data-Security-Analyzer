...
urlpatterns = [
    ...
    path("api/regex_search/", views.api_regex_search, name="api_regex_search"),
    path("api/malware_scan/", views.api_malware_scan, name="api_malware_scan"),
    path("api/quarantine/", views.api_quarantine, name="api_quarantine"),
    path("api/classify_file/", views.api_classify_file, name="api_classify_file"),
    path("regex_search/", views.regex_search, name="regex_search"),
    path("regex_search_results/", views.regex_search_results, name="regex_search_results"),
    ...
    path('sensitive_data_scan/', views.sensitive_data_scan, name='sensitive_data_scan'),
    path('sensitive_data_results/', views.sensitive_data_results, name='sensitive_data_results'),
    path('malware_scan/', views.malware_scan, name='malware_scan'),
]